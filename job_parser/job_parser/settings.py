...
HEADHUNTER_PARSE = os.getenv("HEADHUNTER_PARSE", 10)
ZARPLATA_PARSE = os.getenv("ZARPLATA_PARSE", 10)
SUPERJOB_PARSE = os.getenv("SUPERJOB_PARSE", 10)
TRUDVSEM_PARSE = os.getenv("TRUDVSEM_PARSE", 10)
